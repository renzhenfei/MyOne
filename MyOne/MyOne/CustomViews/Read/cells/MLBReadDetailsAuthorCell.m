...
NSString *const KMLReadDetailsAuthorCellID = @"KMLReadDetailsAuthorCellID";
...
- (void)setupViews {
    ...
    self.usernameLabel = ({
        UILabel *label = [MLBUIFactory lableWithTextColor:MLBLightBlueTextColor font:FontWithSize(12)];
    ...
    self.dateLabel = ({
        UILabel *label = [MLBUIFactory lableWithTextColor:MLBColorC6C6C6 font:FontWithSize(12)];
        [self.contentView addSubview:label];
        [label mas_makeConstraints:^(MASConstraintMaker *make) {
