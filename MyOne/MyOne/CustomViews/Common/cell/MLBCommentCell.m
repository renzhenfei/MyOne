...
NSString *const KMLCommentCellID = @"KMLCommentCellID";
...
- (void)setupViews {
    ...
    _usernameLabel = ({
        UILabel *label = [MLBUIFactory lableWithTextColor:MLBColor4A90E2 font:FontWithSize(15)];
    ...
    _dateLabel = ({
        UILabel *label = [MLBUIFactory lableWithTextColor:MLBColorB8B8B8 font:FontWithSize(12)];
        [_mainView addSubview:label];
        [label mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    _replyContentLabel = ({
        UILabel *label = [MLBUIFactory lableWithTextColor:MLBColor626262 font:FontWithSize(13) numberOfLine:3];
    ...
    _contentLabel = ({
        UILabel *label = [MLBUIFactory lableWithTextColor:MLBColor0E0E0E font:FontWithSize(16) numberOfLine:5];
        label.lineBreakMode = NSLineBreakByTruncatingTail;
